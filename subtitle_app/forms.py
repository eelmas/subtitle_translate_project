...
class DocumentForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['description'].widget.attrs.update({'id': 'id_description', 'class': 'form-control',
                                                        'placeholder': "Enter file name"})
        self.fields['source_language'].widget.attrs.update({'id': "id_source_language", 'class': 'form-control'})
        self.fields['target_language'].widget.attrs.update({'id': "id_target_language", 'class': 'form-control',
                                                            'required': ''})
